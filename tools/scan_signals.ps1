...
param(
  ...
  # отсев на входе через $EXCLUDED в live_engine.ps1; с 2026-07-14 реал = 16 пар (без XRP/APT/OP/AAVE, DOGE
  # торгуется) — решение пользователя по docs/backtests/backtest_current_strategy_2026-07.md.

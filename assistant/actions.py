...
ASSET_RU = {
    ...
    'Si': 'доллар-рубль', 'CNY': 'юань', 'MIX': 'индекс МосБиржи',
    # 2026-08: расширение до 12. RTS выведен из торговли, но оставлен в карте имён,
    # чтобы старые сделки и отчёты по нему продолжали отображаться по-русски.
